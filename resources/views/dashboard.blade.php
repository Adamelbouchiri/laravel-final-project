<x-app-layout>
    ...
    <div id="about" class="fade-in pt-[150px] px-[50px]">
        ...
        <div class="flex flex-col justify-center items-center pb-20">
            ...
            <p class="w-[800px] text-gray-400 leading-8 text-center">- We are dedicated to transforming education
                through innovative digital solutions, offering a comprehensive and accessible e-learning platform that
                empowers learners worldwide. Our goal is to bridge knowledge gaps by delivering personalized, engaging,
                and quality learning experiences for all</p>
        </div>
        <div class="flex flex-col justify-center items-center pb-20">
            <h1 class="text-3xl text-[#94c4c6] tracking-wider font-bold mb-10">What We Offer</h1>
            <p class="w-[800px] text-gray-400 leading-8 text-center">- Our platform provides a wide range of courses
