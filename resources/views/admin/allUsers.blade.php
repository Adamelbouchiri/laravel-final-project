...
<body class="bg-[#94c4c6] min-h-screen">
    ...
    <h1 class="text-2xl font-bold text-zinc-100 mb-6 text-center pt-8">Users</h1>
      ...
      <table class="min-w-full bg-white border-collapse border border-gray-300">
        ...
        <tr class="odd:bg-gray-100">
            ...
            <td class="flex justify-center py-2 px-4 border border-gray-300">
                <form action="{{ route('admin.coachUser',$user->id) }}" method="POST" class="flex items-center space-x-2">
                    @csrf
                    <button type="submit" class="bg-yellow-500 text-white py-1 px-3 rounded hover:bg-yellow-600">Turn To coach</button>
                </form>
            </td>
        </tr>
        @endforeach
